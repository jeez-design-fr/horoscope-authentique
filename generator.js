            ...
            <div class="w-[50vw] md:w-96 text-center group cursor-pointer z-20">
                <a href="etude-karmique.html" class="block">
                    <div class="relative mb-4">
                        ...
                        <div class="absolute top-0 right-2 md:right-4 bg-[#D4AF37] text-white text-[10px] md:text-xs font-bold px-3 py-1 uppercase tracking-widest shadow-lg transform rotate-12">Ouverture</div>
                    </div>
